import{j as e}from"./vendor-query-Bj6efJQO.js";import{u as Y,r as a}from"./vendor-router-D4U-j562.js";import{u as F,d as A,E as S}from"./index-DUfzAu_U.js";import{aP as m,aV as u,aW as P,aX as b,X as x,aY as h,aZ as E,at as I,al as U,Z as L,a_ as R,o as _,N as $,i as f,a$ as B}from"./vendor-icons-Cp8536vp.js";import"./vendor-ui-CKS7PsNe.js";import"./vendor-charts-BqW4h57O.js";const D=[{key:"free_trial",icon:L,label:"تجريبي",price:"مجاناً",period:"14 يوم",color:"#6B7280",highlight:!1,features:["100 طلب","20 منتج","2 مستخدمين","دعم أساسي"]},{key:"starter",icon:R,label:"أساسي",price:"٢٩٩",period:"شهرياً",color:"#C9A84C",highlight:!1,features:["2,000 طلب","100 منتج","5 مستخدمين","تقارير متقدمة","دعم أولوية"]},{key:"pro",icon:u,label:"احترافي",price:"٦٩٩",period:"شهرياً",color:"#C9A84C",highlight:!0,badge:"الأكثر طلباً",features:["طلبات غير محدودة","999 منتج","20 مستخدم","تحليلات ذكية","إدارة مخازن","دعم 24/7"]},{key:"enterprise",icon:_,label:"مؤسسي",price:"تواصل معنا",period:"",color:"#C9A84C",highlight:!1,features:["غير محدود بالكامل","99 مستخدم","API مخصص","تدريب الفريق","مدير حساب مخصص"]}];function V(){const{login:v}=F(),[,w]=Y(),{toast:j}=A(),[i,k]=a.useState(""),[o,y]=a.useState(""),[d,N]=a.useState(!1),[c,g]=a.useState(!1),[z,n]=a.useState(!1),[C,s]=a.useState(!1),X=async r=>{if(r.preventDefault(),!(!i.trim()||!o)){g(!0);try{const{token:t,user:l}=await S.login(i.trim(),o);v(t,l),w("/")}catch(t){j({title:"خطأ في تسجيل الدخول",description:t.message,variant:"destructive"})}finally{g(!1)}}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        :root {
          --gold:       #C9A84C;
          --gold-light: #E8C96A;
          --gold-dim:   #8B6914;
      ...
      `}),e.jsx("div",{className:"lp",children:e.jsxs("div",{className:"hc",children:[e.jsxs("div",{className:"fu1 logo-wrap",children:[e.jsx("div",{className:"logo-ring",children:e.jsx("img",{src:"/logo.jpg",alt:"Caprina"})}),e.jsxs("div",{className:"logo-text-block",children:[e.jsx("span",{className:"logo-brand",children:"CAPRINA"}),e.jsx("span",{className:"logo-sub",children:"Operations System"})]})]}),e.jsx("div",{className:"fu2 gold-divider"}),e.jsx("div",{className:"fu2",children:e.jsxs("h1",{className:"h-title",children:["مرحباً بك في",e.jsx("br",{}),e.jsx("span",{className:"g",children:"مركز العمليات"})]})}),e.jsx("div",{className:"fu3",children:e.jsx("p",{className:"h-desc",children:"نظام متكامل لإدارة الطلبيات والعمليات وتنفيذها على نطاق واسع"})}),e.jsx("div",{className:"fu3",children:e.jsx("span",{className:"tagline",children:"WIN OR DIE"})}),e.jsxs("div",{className:"fu4 btn-row",children:[e.jsxs("button",{className:"btn-primary",onClick:()=>n(!0),children:[e.jsx(m,{size:18})," تسجيل الدخول"]}),e.jsxs("button",{className:"btn-ghost",onClick:()=>s(!0),children:[e.jsx(u,{size:18})," الباقات والأسعار"]}),e.jsxs("a",{href:"https://caprinaeg.com",target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx(P,{size:18})," الموقع الرئيسي"]})]}),e.jsxs("div",{className:"fu5 copy-bar",children:[e.jsx("div",{className:"copy-line"}),e.jsx("span",{className:"copy-text",children:"جميع الحقوق محفوظة © CAPRINA 2026"}),e.jsx("div",{className:"copy-line r"})]})]})}),z&&e.jsx("div",{className:"ov",onClick:()=>n(!1),children:e.jsxs("div",{className:"card",onClick:r=>r.stopPropagation(),children:[e.jsx("div",{className:"card-top-line"}),e.jsxs("div",{className:"card-head",children:[e.jsxs("div",{className:"card-head-left",children:[e.jsx("div",{className:"card-icon",children:e.jsx(b,{size:19})}),e.jsxs("div",{children:[e.jsx("div",{className:"card-title",children:"تسجيل الدخول"}),e.jsx("div",{className:"card-sub",children:"أدخل بياناتك للمتابعة إلى لوحة التحكم"})]})]}),e.jsx("button",{className:"btn-x",onClick:()=>n(!1),children:e.jsx(x,{size:13})})]}),e.jsxs("form",{onSubmit:X,children:[e.jsxs("label",{className:"f-label",children:[e.jsx(h,{size:12})," اسم المستخدم"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(h,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",value:i,onChange:r=>k(r.target.value),placeholder:"أدخل اسم المستخدم",autoComplete:"username",autoFocus:!0})]}),e.jsxs("label",{className:"f-label",children:[e.jsx(b,{size:12})," كلمة المرور"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(E,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",type:d?"text":"password",value:o,onChange:r=>y(r.target.value),placeholder:"••••••••",autoComplete:"current-password",style:{paddingLeft:"2.6rem"}}),e.jsx("button",{type:"button",className:"f-ico-l",onClick:()=>N(r=>!r),children:d?e.jsx(I,{size:14}):e.jsx(U,{size:14})})]}),e.jsx("button",{type:"submit",className:"btn-sub",disabled:c||!i.trim()||!o,children:c?e.jsx(e.Fragment,{children:"جاري التحقق..."}):e.jsxs(e.Fragment,{children:[e.jsx(m,{size:17})," دخول آمن"]})})]})]})}),C&&e.jsx("div",{className:"pricing-ov",onClick:()=>s(!1),children:e.jsxs("div",{className:"pricing-wrap",onClick:r=>r.stopPropagation(),children:[e.jsx("div",{className:"pricing-close",style:{marginBottom:"1rem"},children:e.jsx("button",{className:"btn-x",onClick:()=>s(!1),style:{width:36,height:36,fontSize:"1rem"},children:e.jsx(x,{size:15})})}),e.jsxs("div",{className:"pricing-head",children:[e.jsxs("h2",{className:"pricing-title",children:["اختر ",e.jsx("span",{className:"g",children:"الباقة المناسبة"})]}),e.jsx("p",{className:"pricing-sub",children:"جميع الباقات تشمل وصولاً كاملاً للنظام — فقط الحدود تختلف"})]}),e.jsx("div",{className:"pricing-grid",children:D.map(r=>{const t=r.icon,l=encodeURIComponent(`مرحباً، أريد الاشتراك في باقة ${r.label} من نظام Caprina`);return e.jsxs("div",{className:`plan-card${r.highlight?" hot":""}`,children:[r.highlight&&e.jsxs("div",{className:"plan-badge",children:["★ ",r.badge]}),e.jsx("div",{className:"plan-icon",children:e.jsx(t,{size:20})}),e.jsx("div",{className:"plan-name",children:r.label}),e.jsxs("div",{className:"plan-price",children:[e.jsx("span",{className:"plan-amount",children:r.price}),r.period&&e.jsxs("span",{className:"plan-period",children:["ج.م / ",r.period]})]}),e.jsx("div",{className:"plan-divider"}),e.jsx("div",{className:"plan-features",children:r.features.map(p=>e.jsxs("div",{className:"plan-feat",children:[e.jsx($,{size:13})," ",p]},p))}),e.jsxs("a",{href:`https://wa.me/201XXXXXXXXX?text=${l}`,target:"_blank",rel:"noopener noreferrer",className:`plan-cta${r.highlight?" hot":""}`,style:{textDecoration:"none"},children:[e.jsx(f,{size:15}),r.key==="enterprise"?"تواصل معنا":"ابدأ الآن"]})]},r.key)})}),e.jsxs("div",{className:"pricing-contact",children:[e.jsxs("a",{href:"https://wa.me/201XXXXXXXXX",target:"_blank",rel:"noopener noreferrer",className:"contact-btn contact-wa",children:[e.jsx(f,{size:16})," واتساب"]}),e.jsxs("a",{href:"mailto:info@caprinaeg.com",className:"contact-btn contact-mail",children:[e.jsx(B,{size:16})," info@caprinaeg.com"]})]}),e.jsx("p",{className:"pricing-note",children:"الأسعار بالجنيه المصري · التفعيل خلال 24 ساعة · لا توجد رسوم خفية"})]})})]})}export{V as default};
