import{j as e}from"./vendor-query-Bj6efJQO.js";import{u as A,r as i}from"./vendor-router-D4U-j562.js";import{u as L,f as I,E as U}from"./index-Dnz643lc.js";import{aZ as h,r as w,b3 as D,b4 as x,X as f,b5 as u,b6 as R,aC as $,ar as G,Z as M,b7 as _,n as B,V as O,a3 as v,b8 as Z}from"./vendor-icons-xP5LoOAQ.js";import"./vendor-ui-Cn8aAhmJ.js";import"./vendor-charts-PMSlt1GD.js";const T=[{key:"free_trial",icon:M,label:"تجريبي",monthlyPrice:null,yearlyPrice:null,yearlySaving:null,priceDisplay:"مجاناً",period:"14 يوم",highlight:!1,features:["100 طلب","20 منتج","2 مستخدمين","دعم أساسي"]},{key:"starter",icon:_,label:"أساسي",monthlyPrice:199,yearlyPrice:1990,yearlySaving:398,priceDisplay:"١٩٩",period:"شهرياً",highlight:!1,features:["2,000 طلب","100 منتج","5 مستخدمين","تقارير متقدمة","دعم أولوية"]},{key:"pro",icon:w,label:"احترافي",monthlyPrice:399,yearlyPrice:3990,yearlySaving:798,priceDisplay:"٣٩٩",period:"شهرياً",highlight:!0,badge:"الأكثر طلباً",features:["طلبات غير محدودة","999 منتج","20 مستخدم","تحليلات ذكية","إدارة مخازن","دعم 24/7"]},{key:"enterprise",icon:B,label:"مؤسسي",monthlyPrice:null,yearlyPrice:null,yearlySaving:null,priceDisplay:"تواصل معنا",period:"",highlight:!1,features:["غير محدود بالكامل","99 مستخدم","API مخصص","تدريب الفريق","مدير حساب مخصص"]}];function Q(){const{login:y}=L(),[,k]=A(),{toast:j}=I(),[o,z]=i.useState(""),[s,N]=i.useState(""),[c,C]=i.useState(!1),[g,p]=i.useState(!1),[P,l]=i.useState(!1),[S,d]=i.useState(!1),[t,X]=i.useState(!1),Y=async r=>{if(r.preventDefault(),!(!o.trim()||!s)){p(!0);try{const{token:n,user:a}=await U.login(o.trim(),s);y(n,a),k("/")}catch(n){j({title:"خطأ في تسجيل الدخول",description:n.message,variant:"destructive"})}finally{p(!1)}}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        :root {
          --gold:       #C9A84C;
          --gold-light: #E8C96A;
          --gold-dim:   #8B6914;
