...
// â”€â”€â”€ 1. Ad Attribution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function AdAttributionSection({ bestSource, breakdown, showProfit }: { bestSource: AdSourceStat | null; breakdown: AdSourceStat[]; showProfit: boolean }) {
  ...
  return (
    <div>
      <SectionHeader icon={Zap} title="ط£ظپط¶ظ„ ظ…ظ†طµط© ط¥ط¹ظ„ط§ظ†ظٹط©" subtitle={showProfit ? "طµط§ظپظٹ ط§ظ„ط±ط¨ط­ ط§ظ„ط­ظ‚ظٹظ‚ظٹ ظ„ظƒظ„ ظ‚ظ†ط§ط© طھط³ظˆظٹظ‚ظٹط©" : "ط¥ظٹط±ط§ط¯ط§طھ ظƒظ„ ظ‚ظ†ط§ط© طھط³ظˆظٹظ‚ظٹط©"} color="text-amber-500 dark:text-amber-400" />
      ...
      {bestSource && best && (
        <div className={`mb-4 rounded-xl border-2 ${best.border} ${best.bg} p-4 flex flex-col sm:flex-row sm:items-center gap-4`}>
          <div className="flex items-center gap-3 flex-1">
            ...
            <div>
              <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider">{showProfit ? "ط§ظ„ط£ط¹ظ„ظ‰ ط±ط¨ط­ط§ظ‹" : "ط§ظ„ط£ط¹ظ„ظ‰ ظ…ط¨ظٹط¹ط§ظ‹"}</p>
              <p className={`text-2xl font-black ${best.color}`}>{best.label}</p>
              <p className="text-xs text-muted-foreground mt-0.5">{fn(bestSource.orders)} ط·ظ„ط¨ â€¢ {bestSource.returnRate}% ظ…ط±طھط¬ط¹</p>
            </div>
          </div>
          <div className="flex gap-4 sm:text-right">
            {showProfit && (
              <div>
                <p className="text-[10px] text-muted-foreground">طµط§ظپظٹ ط§ظ„ط±ط¨ط­</p>
            ...
            <div>
              <p className="text-[10px] text-muted-foreground">ط§ظ„ط¥ظٹط±ط§ط¯ط§طھ</p>
      ...
      <div className="space-y-2">
            ...
            <div key={s.source} className="flex items-center gap-3 py-2.5 px-3 rounded-lg bg-card border border-border">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-3 mt-1">
                  <span className="text-[10px] text-muted-foreground">{fn(s.orders)} ط·ظ„ط¨</span>
                  <span className="text-[10px] text-muted-foreground">{s.returnRate}% ظ…ط±طھط¬ط¹</span>
                  {showProfit && <span className="text-[10px] text-muted-foreground">ط¥ظٹط±ط§ط¯ط§طھ: {fc(s.revenue)}</span>}
                </div>
              </div>
            </div>
          );
        ...
        {breakdown.length === 0 && (
          <p className="text-sm text-muted-foreground text-center py-6">ظ„ط§ طھظˆط¬ط¯ ط¨ظٹط§ظ†ط§طھ ط¥ط¹ظ„ط§ظ†ظٹط© ط¨ط¹ط¯</p>
        )}
      </div>
    </div>
  );
...
// â”€â”€â”€ 2. Stars vs Dead Stock â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function StarsSection({ stars, deadStock, showProfit }: { stars: SmartProduct[]; deadStock: DeadStockItem[]; showProfit: boolean }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
      {/* Stars */}
      <div>
        <SectionHeader icon={Star} title="ط§ظ„ظ…ظ†طھط¬ط§طھ ط§ظ„ظ†ط¬ظˆظ…" subtitle={showProfit ? "ط£ط¹ظ„ظ‰ 5 ظ…ظ†طھط¬ط§طھ ط¨طµط§ظپظٹ ط±ط¨ط­" : "ط£ط¹ظ„ظ‰ 5 ظ…ظ†طھط¬ط§طھ ظ…ط¨ظٹط¹ط§ظ‹"} color="text-amber-500 dark:text-amber-400" />
        <div className="space-y-2">
          {stars.map((p, i) => (
            <div key={p.name} className="flex items-center gap-3 p-3 rounded-lg bg-card border border-border">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-muted-foreground">
                  {fn(p.quantity)} ظˆط­ط¯ط©{showProfit ? ` â€¢ ${p.margin}% ظ‡ط§ظ…ط´` : ""}
                </p>
              </div>
              <div className="text-left shrink-0">
                {showProfit ? (
                  ...
                  <p className="text-xs font-black text-primary">{fn(p.quantity)} ظˆط­ط¯ط©</p>
                )}
                <p className="text-[9px] text-muted-foreground">{p.returnRate}% ظ…ط±طھط¬ط¹</p>
              </div>
            </div>
          ))}
          {stars.length === 0 && (
            <div className="text-center py-8 text-muted-foreground text-xs">
              ...
              ظ„ط§ طھظˆط¬ط¯ ظ…ظ†طھط¬ط§طھ ط±ط§ط¨ط­ط© ط¨ط¹ط¯
            </div>
          )}
        </div>
      </div>
      ...
      {/* Dead Stock */}
      <div>
        <SectionHeader icon={Archive} title="ط§ظ„ظ…ط®ط²ظˆظ† ط§ظ„ط±ط§ظƒط¯" subtitle="ظ…ظ†طھط¬ط§طھ ط¨ظ…ط¨ظٹط¹ط§طھ ط£ظ‚ظ„ ظ…ظ† 5 ظˆط­ط¯ط© / 30 ظٹظˆظ…" color="text-orange-600 dark:text-orange-400" />
        <div className="space-y-2">
          {deadStock.map((p) => (
            <div key={p.name} className="flex items-center gap-3 p-3 rounded-lg bg-card border border-amber-200 dark:border-amber-900/40">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-xs truncate">{p.name}</p>
                <p className="text-[10px] text-muted-foreground">
                  {fn(p.availableQty)} ظˆط­ط¯ط© â€¢ {fn(p.last30DaysSales)} ظ…ط¨ظٹط¹/30ظٹظˆظ…
                  {p.daysSinceLastSale !== null && ` â€¢ ط¢ط®ط± ط¨ظٹط¹ ${p.daysSinceLastSale}ظٹظˆظ…`}
                </p>
              </div>
              <div className="text-left shrink-0">
                <p className="text-xs font-bold text-amber-600 dark:text-amber-400">{fc(p.frozenCapital)}</p>
                <p className="text-[9px] text-muted-foreground">ط±ط£ط³ ظ…ط§ظ„ ظ…ط¬ظ…ط¯</p>
              </div>
            </div>
          ))}
          {deadStock.length === 0 && (
...
// â”€â”€â”€ 3. Return Insights â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function ReturnInsightsSection({
  ...
  // build display list: named + collapsed "ط³ط¨ط¨ ط¢ط®ط±" row
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
      {/* Reasons chart */}
      <div>
        <SectionHeader icon={RotateCcw} title="ط£ط³ط¨ط§ط¨ ط§ظ„ظ…ط±طھط¬ط¹ط§طھ" subtitle={`${fn(totalReturns)} ظ…ط±طھط¬ط¹ â€¢ ظ†ط³ط¨ط© ${totalReturnRate}% ظ…ظ† ط§ظ„ط·ظ„ط¨ط§طھ`} color="text-red-600 dark:text-red-400" />
        <div className="space-y-3">
          ...
          {/* ط³ط¨ط¨ ط¢ط®ط± â€” ظ‚ط§ط¨ظ„ ظ„ظ„طھظˆط³ظٹط¹ */}
          {(otherNotes.length > 0 || otherItem) && (
            <div>
              ...
              {/* ط§ظ„طھظپط§طµظٹظ„ ط¹ظ†ط¯ ط§ظ„ط¶ط؛ط· */}
              {showOtherNotes && (
                <div className="mt-2 space-y-2 pr-3 border-r-2 border-amber-500/30">
                  ...
                  {otherItem && (
                    <div>
                      <div className="flex items-center justify-between mb-0.5">
                        <span className="text-xs text-muted-foreground">ط؛ظٹط± ظ…ظپطµظ‘ظ„</span>
          ...
          {byReason.length === 0 && (
            <div className="text-center py-6 text-muted-foreground text-xs">
              ...
              ظ„ط§ طھظˆط¬ط¯ ظ…ط±طھط¬ط¹ط§طھ ظ…ط³ط¬ظ„ط©
            </div>
          )}
        </div>
      </div>
      ...
      <div>
        <SectionHeader icon={AlertTriangle} title="طھط­ط°ظٹط±: ظ†ط³ط¨ط© ظ…ط±طھط¬ط¹ ط¹ط§ظ„ظٹط©" subtitle="ظ…ظ†طھط¬ط§طھ طھط¬ط§ظˆط²طھ 50% ظ…ط±طھط¬ط¹" color="text-red-600 dark:text-red-400" />
        <div className="space-y-2">
          {highReturnProducts.map((p) => (
            <div key={p.name} className="flex items-center gap-3 p-3 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-xs truncate">{p.name}</p>
                <p className="text-[10px] text-red-600 dark:text-red-400">{p.returnCount} ظ…ظ† {p.orderCount} ط·ظ„ط¨</p>
              </div>
          ...
          {highReturnProducts.length === 0 && (
            <div className="flex items-center gap-3 p-4 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50">
              ...
              <div>
                <p className="text-xs font-bold text-emerald-700 dark:text-emerald-400">ظ„ط§ ظٹظˆط¬ط¯ ظ…ظ†طھط¬ طھط¬ط§ظˆط² 50% ظ…ط±طھط¬ط¹</p>
                <p className="text-[10px] text-muted-foreground">ظ…ط¹ط¯ظ„ط§طھ ط§ظ„ظ…ط±طھط¬ط¹ط§طھ طھط­طھ ط§ظ„ط³ظٹط·ط±ط©</p>
              </div>
            </div>
          )}
        </div>
...
// â”€â”€â”€ 4. Stock Predictor â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function StockPredictorSection({ items }: { items: StockPredictorItem[] }) {
  function urgencyColor(days: number | null) {
    if (days === null) return { bg: "bg-zinc-50 dark:bg-zinc-800/30", border: "border-zinc-200 dark:border-zinc-700", badge: "bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-300", text: "ظ†ط§ظ…ظٹ" };
    if (days <= 3)  return { bg: "bg-red-50 dark:bg-red-900/20",     border: "border-red-300 dark:border-red-800/60",     badge: "bg-red-500 text-white",    text: `${days} ط£ظٹط§ظ… ظپظ‚ط·!` };
    if (days <= 7)  return { bg: "bg-orange-50 dark:bg-orange-900/20",border: "border-orange-300 dark:border-orange-800/60",badge: "bg-orange-500 text-white", text: `${days} ط£ظٹط§ظ…` };
    return { bg: "bg-amber-50 dark:bg-amber-900/20", border: "border-amber-300 dark:border-amber-800/60", badge: "bg-amber-500 text-white", text: `${days} ظٹظˆظ…` };
  }

  return (
    <div>
      <SectionHeader icon={Clock} title="ط§ظ„طھظ†ط¨ط¤ ط¨ط§ظ„ظ…ط®ط²ظˆظ†" subtitle="ظ…ظ†طھط¬ط§طھ ط³طھظ†طھظ‡ظٹ ط®ظ„ط§ظ„ 14 ظٹظˆظ… ط¨ظ†ط§ط،ظ‹ ط¹ظ„ظ‰ ظ…ط¹ط¯ظ„ ط§ظ„ط¨ظٹط¹" color="text-sky-600 dark:text-sky-400" />
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          return (
            <div key={item.name} className={`flex items-center gap-3 p-3 rounded-lg border ${u.bg} ${u.border}`}>
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-muted-foreground">
                  ط¨ط§ظ‚ظٹ {fn(item.availableQty)} ظˆط­ط¯ط© â€¢ {item.velocityPerDay} ظˆط­ط¯ط©/ظٹظˆظ…
                </p>
              </div>
        ...
        {items.length === 0 && (
          <div className="col-span-2 text-center py-8 text-muted-foreground text-xs">
            ...
            ظ„ط§ طھظˆط¬ط¯ ظ…ظ†طھط¬ط§طھ ط¹ظ„ظ‰ ظˆط´ظƒ ط§ظ„ظ†ظپط§ط¯ ط®ظ„ط§ظ„ 14 ظٹظˆظ…
          </div>
        )}
      </div>
    </div>
...
// â”€â”€â”€ 5. Cash Flow Chart (ط¢ط®ط± 6 ط´ظ‡ظˆط±) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function CashFlowSection() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1">
        <SectionHeader icon={TrendingUp} title="ط§ظ„طھط¯ظپظ‚ ط§ظ„ظ…ط§ظ„ظٹ" subtitle="ط§ظ„ظ…ط¨ظٹط¹ط§طھ â€” ط¢ط®ط± 6 ط´ظ‡ظˆط±" color="text-primary" />
        {/* Dropdown ظ†ظˆط¹ ط§ظ„ط±ط³ظ… */}
        <div className="relative" ref={dropRef}>
          ...
          >
            ...
            {chartView === "area" ? "ط®ط·ظٹ" : "ط¨ظٹط§ظ†ظٹ"}
          ...
          {dropOpen && (
            <div className="absolute left-0 top-full mt-1.5 w-36 bg-card border border-border rounded-xl shadow-xl z-50 overflow-hidden">
              {[
                { key: "area", label: "ط®ط·ظٹ طھط¯ط±ط¬ظٹ", icon: (
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <polyline points="1,11 4,7 7,9 10,4 13,2" stroke="currentColor" strokeWidth="1.8" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                    <polygon points="1,11 4,7 7,9 10,4 13,2 13,13 1,13" fill="currentColor" opacity="0.2"/>
                  </svg>
                )},
                { key: "bar", label: "ط£ط¹ظ…ط¯ط©", icon: (
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <rect x="1" y="6" width="3" height="7" rx="1" fill="currentColor" opacity="0.6"/>
                    <rect x="5.5" y="3" width="3" height="10" rx="1" fill="currentColor"/>
                    <rect x="10" y="1" width="3" height="12" rx="1" fill="currentColor" opacity="0.6"/>
                ...
                <button key={opt.key}
                  ...
                  {opt.icon}
                  {opt.label}
                  {chartView === opt.key && <span className="mr-auto text-primary">âœ“</span>}
                </button>
              ))}
            </div>
          )}
      ...
      <div className="flex items-end gap-4 mb-3">
        <div>
          ...
          <p className="text-[11px] text-primary">ط¥ط¬ظ…ط§ظ„ظٹ ط¢ط®ط± 6 ط´ظ‡ظˆط±</p>
        </div>
        {bestMonth && bestMonth.value > 0 && (
          <div className="mb-0.5">
            <p className="text-xs text-muted-foreground">ط£ظپط¶ظ„ ط´ظ‡ط±</p>
            <p className="text-sm font-bold">{bestMonth.date} â€” {fc(bestMonth.value)}</p>
          </div>
        )}
      </div>
        ...
        {chartView === "area" ? (
          <AreaChart data={chartData} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
            ...
            <Tooltip
              ...
              formatter={(v: any) => [fc(v), "ط§ظ„ظ…ط¨ظٹط¹ط§طھ"]}
            />
...
// â”€â”€â”€ Summary Stats Bar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <Card className="border-border bg-card">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] font-bold text-muted-foreground uppercase">ط£ظپط¶ظ„ ظ…ظ†طµط©</span>
          </div>
          {data.adAttribution.bestSource ? (
            ...
            <p className="text-xs text-muted-foreground">ظ„ط§ ط¨ظٹط§ظ†ط§طھ</p>
          )}
        </CardContent>
      </Card>
      ...
      <Card className="border-border bg-card">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] font-bold text-muted-foreground uppercase">ظ†ط¬ظˆظ… / ط±ط§ظƒط¯</span>
          </div>
          <p className="font-black text-sm">{data.stars.length} ظ†ط¬ظˆظ… â€¢ {data.deadStock.length} ط±ط§ظƒط¯</p>
          {totalFrozen > 0 && <p className="text-[10px] text-amber-600 dark:text-amber-400 font-bold">{fc(totalFrozen)} ظ…ط¬ظ…ط¯</p>}
        </CardContent>
      </Card>
      ...
      <Card className={`border-border bg-card ${highReturn > 0 ? "border-red-300 dark:border-red-800" : ""}`}>
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] font-bold text-muted-foreground uppercase">ط§ظ„ظ…ط±طھط¬ط¹ط§طھ</span>
          </div>
          <p className="font-black text-sm">{data.returnInsights.totalReturnRate}% ظ…ط¹ط¯ظ„ ط¥ط±ط¬ط§ط¹</p>
          {highReturn > 0 && <p className="text-[10px] text-red-500 font-bold">âڑ ï¸ڈ {highReturn} ظ…ظ†طھط¬ طھط¬ط§ظˆط² 50%</p>}
        </CardContent>
      </Card>
      ...
      <Card className={`border-border bg-card ${critical > 0 ? "border-red-300 dark:border-red-800" : ""}`}>
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] font-bold text-muted-foreground uppercase">ط§ظ„ظ…ط®ط²ظˆظ† ط§ظ„ط­ط±ط¬</span>
          </div>
          <p className="font-black text-sm">{data.stockPredictor.length} ظ…ظ†طھط¬</p>
          {critical > 0 ? (
            <p className="text-[10px] text-red-500 font-bold">ًںڑ¨ {critical} ط³ظٹظ†ظپط¯ ط®ظ„ط§ظ„ 3 ط£ظٹط§ظ…</p>
          ) : (
            <p className="text-[10px] text-muted-foreground">ط³طھظ†ظپط¯ ط®ظ„ط§ظ„ 14 ظٹظˆظ…</p>
          )}
        </CardContent>
      </Card>
    </div>
  ...
  if (!isAdmin && !can("analytics.smart")) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-3 text-muted-foreground">
        ...
        <p className="text-sm font-bold">ظ‡ط°ظ‡ ط§ظ„طµظپط­ط© ظ„ظ„ظ…ط¯ظٹط±ظٹظ† ظپظ‚ط·</p>
        <button onClick={() => navigate("/")} className="text-xs text-primary hover:underline">ط§ظ„ط¹ظˆط¯ط© ظ„ظ„ط±ط¦ظٹط³ظٹط©</button>
      </div>
    );
  }
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-black">ط§ظ„طھط­ظ„ظٹظ„ ط§ظ„ط°ظƒظٹ</h1>
          </div>
          <p className="text-muted-foreground text-sm">ظ‚ط±ط§ط±ط§طھ ظ…ط¨ظ†ظٹط© ط¹ظ„ظ‰ ط§ظ„ط¨ظٹط§ظ†ط§طھ â€” ط¥ط¹ظ„ط§ظ†ط§طھطŒ ظ…ظ†طھط¬ط§طھطŒ ظ…ط±طھط¬ط¹ط§طھطŒ ظ…ط®ط²ظˆظ†</p>
        </div>
        <Link href="/ads-analytics">
          <button className="flex items-center gap-2 text-xs text-primary border border-primary/30 hover:bg-primary/5 px-3 py-1.5 rounded-lg transition-colors">
            <ArrowUpRight className="w-3.5 h-3.5" />طھظپط§طµظٹظ„ ط§ظ„ط­ظ…ظ„ط§طھ
          </button>
        </Link>
      </div>
