  ...
  const handlePrint = async (invoiceNumbers = selectedIds) => {
    ...
    const styles = `
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .inv-body { padding: 1mm 3mm; flex: 1; min-height: 0; display: flex; flex-direction: column; gap: 0.8mm; overflow: hidden; }
