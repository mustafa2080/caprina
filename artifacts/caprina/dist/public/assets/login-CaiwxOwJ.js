import{j as e}from"./vendor-query-Bj6efJQO.js";import{u as j,r as a}from"./vendor-router-D4U-j562.js";import{u as k,d as z,E as N}from"./index-A5WvKd0r.js";import{aP as g,aV as C,aW as c,X as F,aX as p,aY as Y,at as S,al as A}from"./vendor-icons-DwsaAl1i.js";import"./vendor-ui-CKS7PsNe.js";import"./vendor-charts-BqW4h57O.js";function O(){const{login:m}=k(),[,b]=j(),{toast:x}=z(),[t,h]=a.useState(""),[i,f]=a.useState(""),[s,u]=a.useState(!1),[l,d]=a.useState(!1),[w,o]=a.useState(!1),v=async r=>{if(r.preventDefault(),!(!t.trim()||!i)){d(!0);try{const{token:n,user:y}=await N.login(t.trim(),i);m(n,y),b("/")}catch(n){x({title:"خطأ في تسجيل الدخول",description:n.message,variant:"destructive"})}finally{d(!1)}}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        :root {
          --gold:       #C9A84C;
          --gold-light: #E8C96A;
          --gold-dim:   #8B6914;
