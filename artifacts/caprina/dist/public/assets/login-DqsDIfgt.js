import{j as e}from"./vendor-query-Bj6efJQO.js";import{u as y,r as a}from"./vendor-router-D4U-j562.js";import{u as k,d as N,E as z}from"./index-DIpZTy1F.js";import{aP as c,aV as C,aW as g,X as F,aX as p,aY as Y,at as S,am as A}from"./vendor-icons-029KCsQ5.js";import"./vendor-ui-Cz2Nrdoo.js";import"./vendor-charts-COgId5Vr.js";function O(){const{login:m}=k(),[,b]=y(),{toast:x}=N(),[t,h]=a.useState(""),[i,f]=a.useState(""),[s,u]=a.useState(!1),[l,d]=a.useState(!1),[v,o]=a.useState(!1),w=async r=>{if(r.preventDefault(),!(!t.trim()||!i)){d(!0);try{const{token:n,user:j}=await z.login(t.trim(),i);m(n,j),b("/")}catch(n){x({title:"خطأ في تسجيل الدخول",description:n.message,variant:"destructive"})}finally{d(!1)}}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        :root {
          --gold:       #C9A84C;
          --gold-light: #E8C96A;
          --gold-dim:   #8B6914;
      ...
      `}),e.jsx("div",{className:"lp",children:e.jsxs("div",{className:"hc",children:[e.jsxs("div",{className:"fu1 logo-wrap",children:[e.jsx("div",{className:"logo-ring",children:e.jsx("img",{src:"/logo.jpg",alt:"Caprina"})}),e.jsxs("div",{className:"logo-text-block",children:[e.jsx("span",{className:"logo-brand",children:"CAPRINA"}),e.jsx("span",{className:"logo-sub",children:"Operations System"})]})]}),e.jsx("div",{className:"fu2 gold-divider"}),e.jsx("div",{className:"fu2",children:e.jsxs("h1",{className:"h-title",children:["مرحباً بك في",e.jsx("br",{}),e.jsx("span",{className:"g",children:"مركز العمليات"})]})}),e.jsx("div",{className:"fu3",children:e.jsx("p",{className:"h-desc",children:"نظام متكامل لإدارة الطلبيات والعمليات وتنفيذها على نطاق واسع"})}),e.jsx("div",{className:"fu3",children:e.jsx("span",{className:"tagline",children:"WIN OR DIE"})}),e.jsxs("div",{className:"fu4 btn-row",children:[e.jsxs("button",{className:"btn-primary",onClick:()=>o(!0),children:[e.jsx(c,{size:18})," تسجيل الدخول"]}),e.jsxs("a",{href:"https://caprinaeg.com",target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx(C,{size:18})," الموقع الرئيسي"]})]}),e.jsxs("div",{className:"fu5 copy-bar",children:[e.jsx("div",{className:"copy-line"}),e.jsx("span",{className:"copy-text",children:"جميع الحقوق محفوظة © CAPRINA 2026"}),e.jsx("div",{className:"copy-line r"})]})]})}),v&&e.jsx("div",{className:"ov",onClick:()=>o(!1),children:e.jsxs("div",{className:"card",onClick:r=>r.stopPropagation(),children:[e.jsx("div",{className:"card-top-line"}),e.jsxs("div",{className:"card-head",children:[e.jsxs("div",{className:"card-head-left",children:[e.jsx("div",{className:"card-icon",children:e.jsx(g,{size:19})}),e.jsxs("div",{children:[e.jsx("div",{className:"card-title",children:"تسجيل الدخول"}),e.jsx("div",{className:"card-sub",children:"أدخل بياناتك للمتابعة إلى لوحة التحكم"})]})]}),e.jsx("button",{className:"btn-x",onClick:()=>o(!1),children:e.jsx(F,{size:13})})]}),e.jsxs("form",{onSubmit:w,children:[e.jsxs("label",{className:"f-label",children:[e.jsx(p,{size:12})," اسم المستخدم"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(p,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",value:t,onChange:r=>h(r.target.value),placeholder:"أدخل اسم المستخدم",autoComplete:"username",autoFocus:!0})]}),e.jsxs("label",{className:"f-label",children:[e.jsx(g,{size:12})," كلمة المرور"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(Y,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",type:s?"text":"password",value:i,onChange:r=>f(r.target.value),placeholder:"••••••••",autoComplete:"current-password",style:{paddingLeft:"2.6rem"}}),e.jsx("button",{type:"button",className:"f-ico-l",onClick:()=>u(r=>!r),children:s?e.jsx(S,{size:14}):e.jsx(A,{size:14})})]}),e.jsx("button",{type:"submit",className:"btn-sub",disabled:l||!t.trim()||!i,children:l?e.jsx(e.Fragment,{children:"جاري التحقق..."}):e.jsxs(e.Fragment,{children:[e.jsx(c,{size:17})," دخول آمن"]})})]})]})})]})}export{O as default};
