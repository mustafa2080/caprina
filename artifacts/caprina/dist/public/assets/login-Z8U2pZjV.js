import{j as e}from"./vendor-query-Bj6efJQO.js";import{u as A,r as i}from"./vendor-router-D4U-j562.js";import{u as L,d as I,E as U}from"./index-T5iVjZy0.js";import{aP as x,aV as y,aW as $,aX as h,X as f,aY as u,aZ as D,at as R,al as G,Z as _,a_ as B,o as M,N as O,i as v,a$ as Z}from"./vendor-icons-Cp8536vp.js";import"./vendor-ui-CKS7PsNe.js";import"./vendor-charts-BqW4h57O.js";const W=[{key:"free_trial",icon:_,label:"تجريبي",monthlyPrice:null,yearlyPrice:null,yearlySaving:null,priceDisplay:"مجاناً",period:"14 يوم",highlight:!1,features:["100 طلب","20 منتج","2 مستخدمين","دعم أساسي"]},{key:"starter",icon:B,label:"أساسي",monthlyPrice:199,yearlyPrice:1990,yearlySaving:398,priceDisplay:"١٩٩",period:"شهرياً",highlight:!1,features:["2,000 طلب","100 منتج","5 مستخدمين","تقارير متقدمة","دعم أولوية"]},{key:"pro",icon:y,label:"احترافي",monthlyPrice:399,yearlyPrice:3990,yearlySaving:798,priceDisplay:"٣٩٩",period:"شهرياً",highlight:!0,badge:"الأكثر طلباً",features:["طلبات غير محدودة","999 منتج","20 مستخدم","تحليلات ذكية","إدارة مخازن","دعم 24/7"]},{key:"enterprise",icon:M,label:"مؤسسي",monthlyPrice:null,yearlyPrice:null,yearlySaving:null,priceDisplay:"تواصل معنا",period:"",highlight:!1,features:["غير محدود بالكامل","99 مستخدم","API مخصص","تدريب الفريق","مدير حساب مخصص"]}];function Q(){const{login:w}=L(),[,j]=A(),{toast:k}=I(),[n,N]=i.useState(""),[s,z]=i.useState(""),[c,C]=i.useState(!1),[g,p]=i.useState(!1),[P,l]=i.useState(!1),[S,d]=i.useState(!1),[t,X]=i.useState(!1),Y=async r=>{if(r.preventDefault(),!(!n.trim()||!s)){p(!0);try{const{token:o,user:a}=await U.login(n.trim(),s);w(o,a),j("/")}catch(o){k({title:"خطأ في تسجيل الدخول",description:o.message,variant:"destructive"})}finally{p(!1)}}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        :root {
          --gold:       #C9A84C;
          --gold-light: #E8C96A;
          --gold-dim:   #8B6914;
        ...
        /* ── Pricing Modal ── */
        .pricing-ov { position:fixed;inset:0;z-index:50;display:flex;align-items:center;justify-content:center;padding:1rem;background:rgba(6,5,4,0.88);backdrop-filter:blur(20px);animation:fadeIn .2s ease;overflow-y:auto; }
        .pricing-wrap { width:100%;max-width:960px;direction:rtl;position:relative; }
        .pricing-head { text-align:center;margin-bottom:2rem; }
        .pricing-title { font-size:1.8rem;font-weight:900;color:var(--white);margin-bottom:.4rem; }
        ...
        .pricing-sub { font-size:.9rem;color:rgba(255,255,255,0.55); }
        .pricing-grid { display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:1rem;margin-bottom:1.5rem; }
        .plan-card {
          background:rgba(18,14,5,0.7);border:1px solid rgba(201,168,76,0.18);border-radius:1.1rem;
          padding:1.6rem 1.4rem;display:flex;flex-direction:column;gap:.8rem;position:relative;overflow:hidden;
          transition:border-color .2s,transform .2s;
        }
        .plan-card:hover { border-color:rgba(201,168,76,0.45);transform:translateY(-3px); }
        .plan-card.hot { border:1.5px solid var(--gold);background:rgba(201,168,76,0.06); }
        ...
        .plan-badge { position:absolute;top:-.5px;left:50%;transform:translateX(-50%);background:var(--gold);color:#090807;font-size:.65rem;font-weight:900;letter-spacing:.1em;padding:.25rem .9rem;border-radius:0 0 .5rem .5rem;white-space:nowrap; }
        .plan-icon { width:42px;height:42px;border-radius:.7rem;background:rgba(201,168,76,0.1);border:1px solid rgba(201,168,76,0.25);display:flex;align-items:center;justify-content:center;color:var(--gold); }
        .plan-name { font-size:1.1rem;font-weight:900;color:var(--white); }
        .plan-price { display:flex;align-items:baseline;gap:.3rem; }
        .plan-amount { font-size:1.9rem;font-weight:900;color:var(--gold); }
        .plan-period { font-size:.75rem;color:rgba(255,255,255,0.4); }
        .plan-divider { height:1px;background:rgba(201,168,76,0.12); }
        .plan-features { display:flex;flex-direction:column;gap:.5rem;flex:1; }
        .plan-feat { display:flex;align-items:center;gap:.5rem;font-size:.8rem;color:rgba(255,255,255,0.75); }
        .plan-feat svg { color:var(--gold);flex-shrink:0; }
        .plan-cta {
          margin-top:auto;width:100%;padding:.7rem;border-radius:.6rem;font-size:.82rem;font-weight:800;
          cursor:pointer;border:1.5px solid rgba(201,168,76,0.4);background:transparent;color:var(--gold-light);
          transition:all .2s;letter-spacing:.05em;display:flex;align-items:center;justify-content:center;gap:.5rem;
        }
        ...
        .pricing-note { text-align:center;font-size:.78rem;color:rgba(255,255,255,0.35);padding:1rem 0; }
        .pricing-contact { display:flex;align-items:center;justify-content:center;gap:1.5rem;flex-wrap:wrap;margin-bottom:1.5rem; }
        .contact-btn { display:flex;align-items:center;gap:.5rem;padding:.6rem 1.4rem;border-radius:.6rem;font-size:.82rem;font-weight:700;cursor:pointer;transition:all .2s;text-decoration:none; }
        ...
        .pricing-close { position:absolute;top:0;left:0;right:0;display:flex;justify-content:flex-end; }

        /* toggle شهري / سنوي */
        .billing-toggle { display:flex;align-items:center;justify-content:center;gap:.8rem;margin-bottom:1.5rem; }
        .billing-label { font-size:.82rem;font-weight:700;color:rgba(255,255,255,0.5);transition:color .2s; }
        .billing-label.active { color:var(--gold-light); }
        .toggle-track { width:48px;height:26px;border-radius:13px;background:rgba(201,168,76,0.2);border:1px solid rgba(201,168,76,0.35);position:relative;cursor:pointer;transition:background .2s; }
        .toggle-track.on { background:rgba(201,168,76,0.35); }
        .toggle-thumb { width:20px;height:20px;border-radius:50%;background:var(--gold);position:absolute;top:2px;right:2px;transition:transform .2s;box-shadow:0 2px 6px rgba(0,0,0,0.4); }
        .toggle-track.on .toggle-thumb { transform:translateX(-22px); }
        .saving-badge { background:rgba(201,168,76,0.15);border:1px solid rgba(201,168,76,0.3);color:var(--gold-light);font-size:.68rem;font-weight:800;padding:.2rem .6rem;border-radius:.4rem;letter-spacing:.05em; }

        /* السعر السنوي في البطاقة */
        .plan-yearly-info { font-size:.72rem;color:rgba(255,255,255,0.4);margin-top:.1rem; }
        .plan-saving { display:inline-block;background:rgba(201,168,76,0.15);border:1px solid rgba(201,168,76,0.25);color:var(--gold);font-size:.68rem;font-weight:800;padding:.15rem .55rem;border-radius:.35rem;margin-top:.2rem; }
      ...
      `}),e.jsx("div",{className:"lp",children:e.jsxs("div",{className:"hc",children:[e.jsxs("div",{className:"fu1 logo-wrap",children:[e.jsx("div",{className:"logo-ring",children:e.jsx("img",{src:"/logo.jpg",alt:"Caprina"})}),e.jsxs("div",{className:"logo-text-block",children:[e.jsx("span",{className:"logo-brand",children:"CAPRINA"}),e.jsx("span",{className:"logo-sub",children:"Operations System"})]})]}),e.jsx("div",{className:"fu2 gold-divider"}),e.jsx("div",{className:"fu2",children:e.jsxs("h1",{className:"h-title",children:["مرحباً بك في",e.jsx("br",{}),e.jsx("span",{className:"g",children:"مركز العمليات"})]})}),e.jsx("div",{className:"fu3",children:e.jsx("p",{className:"h-desc",children:"نظام متكامل لإدارة الطلبيات والعمليات وتنفيذها على نطاق واسع"})}),e.jsx("div",{className:"fu3",children:e.jsx("span",{className:"tagline",children:"WIN OR DIE"})}),e.jsxs("div",{className:"fu4 btn-row",children:[e.jsxs("button",{className:"btn-primary",onClick:()=>l(!0),children:[e.jsx(x,{size:18})," تسجيل الدخول"]}),e.jsxs("button",{className:"btn-ghost",onClick:()=>d(!0),children:[e.jsx(y,{size:18})," الباقات والأسعار"]}),e.jsxs("a",{href:"https://caprinaeg.com",target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx($,{size:18})," الموقع الرئيسي"]})]}),e.jsxs("div",{className:"fu5 copy-bar",children:[e.jsx("div",{className:"copy-line"}),e.jsx("span",{className:"copy-text",children:"جميع الحقوق محفوظة © CAPRINA 2026"}),e.jsx("div",{className:"copy-line r"})]})]})}),P&&e.jsx("div",{className:"ov",onClick:()=>l(!1),children:e.jsxs("div",{className:"card",onClick:r=>r.stopPropagation(),children:[e.jsx("div",{className:"card-top-line"}),e.jsxs("div",{className:"card-head",children:[e.jsxs("div",{className:"card-head-left",children:[e.jsx("div",{className:"card-icon",children:e.jsx(h,{size:19})}),e.jsxs("div",{children:[e.jsx("div",{className:"card-title",children:"تسجيل الدخول"}),e.jsx("div",{className:"card-sub",children:"أدخل بياناتك للمتابعة إلى لوحة التحكم"})]})]}),e.jsx("button",{className:"btn-x",onClick:()=>l(!1),children:e.jsx(f,{size:13})})]}),e.jsxs("form",{onSubmit:Y,children:[e.jsxs("label",{className:"f-label",children:[e.jsx(u,{size:12})," اسم المستخدم"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(u,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",value:n,onChange:r=>N(r.target.value),placeholder:"أدخل اسم المستخدم",autoComplete:"username",autoFocus:!0})]}),e.jsxs("label",{className:"f-label",children:[e.jsx(h,{size:12})," كلمة المرور"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(D,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",type:c?"text":"password",value:s,onChange:r=>z(r.target.value),placeholder:"••••••••",autoComplete:"current-password",style:{paddingLeft:"2.6rem"}}),e.jsx("button",{type:"button",className:"f-ico-l",onClick:()=>C(r=>!r),children:c?e.jsx(R,{size:14}):e.jsx(G,{size:14})})]}),e.jsx("button",{type:"submit",className:"btn-sub",disabled:g||!n.trim()||!s,children:g?e.jsx(e.Fragment,{children:"جاري التحقق..."}):e.jsxs(e.Fragment,{children:[e.jsx(x,{size:17})," دخول آمن"]})})]})]})}),S&&e.jsx("div",{className:"pricing-ov",onClick:()=>d(!1),children:e.jsxs("div",{className:"pricing-wrap",onClick:r=>r.stopPropagation(),children:[e.jsx("div",{className:"pricing-close",style:{marginBottom:"1rem"},children:e.jsx("button",{className:"btn-x",onClick:()=>d(!1),style:{width:36,height:36},children:e.jsx(f,{size:15})})}),e.jsxs("div",{className:"pricing-head",children:[e.jsxs("h2",{className:"pricing-title",children:["اختر ",e.jsx("span",{className:"g",children:"الباقة المناسبة"})]}),e.jsx("p",{className:"pricing-sub",children:"جميع الباقات تشمل وصولاً كاملاً للنظام — فقط الحدود تختلف"})]}),e.jsxs("div",{className:"billing-toggle",children:[e.jsx("span",{className:`billing-label${t?"":" active"}`,children:"شهري"}),e.jsx("div",{className:`toggle-track${t?" on":""}`,onClick:()=>X(r=>!r),children:e.jsx("div",{className:"toggle-thumb"})}),e.jsx("span",{className:`billing-label${t?" active":""}`,children:"سنوي"}),t&&e.jsx("span",{className:"saving-badge",children:"🎁 شهرين مجاناً"})]}),e.jsx("div",{className:"pricing-grid",children:W.map(r=>{const o=r.icon,a=t&&r.yearlyPrice,F=a?`${r.yearlyPrice.toLocaleString("ar-EG")}`:r.priceDisplay,m=a?"سنوياً":r.period,E=encodeURIComponent(`مرحباً، أريد الاشتراك في باقة ${r.label} ${a?"السنوية":"الشهرية"} من نظام Caprina`);return e.jsxs("div",{className:`plan-card${r.highlight?" hot":""}`,children:[r.highlight&&e.jsxs("div",{className:"plan-badge",children:["★ ",r.badge]}),e.jsx("div",{className:"plan-icon",children:e.jsx(o,{size:20})}),e.jsx("div",{className:"plan-name",children:r.label}),e.jsxs("div",{className:"plan-price",children:[e.jsx("span",{className:"plan-amount",children:F}),m&&e.jsxs("span",{className:"plan-period",children:["ج.م / ",m]})]}),a&&r.yearlySaving&&e.jsxs("div",{children:[e.jsxs("div",{className:"plan-yearly-info",children:["بدلاً من ",(r.monthlyPrice*12).toLocaleString("ar-EG")," ج.م"]}),e.jsxs("span",{className:"plan-saving",children:["وفّر ",r.yearlySaving.toLocaleString("ar-EG")," ج.م"]})]}),!a&&r.yearlyPrice&&e.jsxs("div",{className:"plan-yearly-info",children:["السنوي: ",r.yearlyPrice.toLocaleString("ar-EG")," ج.م — وفّر ",r.yearlySaving," ج.م"]}),e.jsx("div",{className:"plan-divider"}),e.jsx("div",{className:"plan-features",children:r.features.map(b=>e.jsxs("div",{className:"plan-feat",children:[e.jsx(O,{size:13})," ",b]},b))}),e.jsxs("a",{href:`https://wa.me/201XXXXXXXXX?text=${E}`,target:"_blank",rel:"noopener noreferrer",className:`plan-cta${r.highlight?" hot":""}`,style:{textDecoration:"none"},children:[e.jsx(v,{size:15}),r.key==="enterprise"?"تواصل معنا":"ابدأ الآن"]})]},r.key)})}),e.jsxs("div",{className:"pricing-contact",children:[e.jsxs("a",{href:"https://wa.me/201XXXXXXXXX",target:"_blank",rel:"noopener noreferrer",className:"contact-btn contact-wa",children:[e.jsx(v,{size:16})," واتساب"]}),e.jsxs("a",{href:"mailto:info@caprinaeg.com",className:"contact-btn contact-mail",children:[e.jsx(Z,{size:16})," info@caprinaeg.com"]})]}),e.jsx("p",{className:"pricing-note",children:"الأسعار بالجنيه المصري · التفعيل خلال 24 ساعة · لا توجد رسوم خفية · البيانات محفوظة حتى بعد انتهاء الاشتراك"})]})})]})}export{Q as default};
