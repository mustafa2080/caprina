import{j as e}from"./vendor-query-Bj6efJQO.js";import{u as A,r as i}from"./vendor-router-D4U-j562.js";import{u as L,d as I,E as U}from"./index-BtSSqP6A.js";import{aP as h,aV as w,aW as $,aX as x,X as f,aY as u,aZ as D,at as R,al as G,Z as _,a_ as M,o as B,N as O,i as v,a$ as Z}from"./vendor-icons-Cp8536vp.js";import"./vendor-ui-CKS7PsNe.js";import"./vendor-charts-BqW4h57O.js";const W=[{key:"free_trial",icon:_,label:"تجريبي",monthlyPrice:null,yearlyPrice:null,yearlySaving:null,priceDisplay:"مجاناً",period:"14 يوم",highlight:!1,features:["100 طلب","20 منتج","2 مستخدمين","دعم أساسي"]},{key:"starter",icon:M,label:"أساسي",monthlyPrice:199,yearlyPrice:1990,yearlySaving:398,priceDisplay:"١٩٩",period:"شهرياً",highlight:!1,features:["2,000 طلب","100 منتج","5 مستخدمين","تقارير متقدمة","دعم أولوية"]},{key:"pro",icon:w,label:"احترافي",monthlyPrice:399,yearlyPrice:3990,yearlySaving:798,priceDisplay:"٣٩٩",period:"شهرياً",highlight:!0,badge:"الأكثر طلباً",features:["طلبات غير محدودة","999 منتج","20 مستخدم","تحليلات ذكية","إدارة مخازن","دعم 24/7"]},{key:"enterprise",icon:B,label:"مؤسسي",monthlyPrice:null,yearlyPrice:null,yearlySaving:null,priceDisplay:"تواصل معنا",period:"",highlight:!1,features:["غير محدود بالكامل","99 مستخدم","API مخصص","تدريب الفريق","مدير حساب مخصص"]}];function Q(){const{login:y}=L(),[,k]=A(),{toast:j}=I(),[o,N]=i.useState(""),[s,z]=i.useState(""),[c,C]=i.useState(!1),[g,p]=i.useState(!1),[P,l]=i.useState(!1),[S,d]=i.useState(!1),[t,X]=i.useState(!1),Y=async r=>{if(r.preventDefault(),!(!o.trim()||!s)){p(!0);try{const{token:n,user:a}=await U.login(o.trim(),s);y(n,a),k("/")}catch(n){j({title:"خطأ في تسجيل الدخول",description:n.message,variant:"destructive"})}finally{p(!1)}}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        :root {
          --gold:       #C9A84C;
          --gold-light: #E8C96A;
          --gold-dim:   #8B6914;
        ...
        .pricing-ov {
          ...
          padding:1rem;
          background:rgba(6,5,4,0.92);backdrop-filter:blur(20px);
        ...
        .pricing-wrap {
          width:100%;max-width:1000px;direction:rtl;position:relative;
          margin:0 auto;
          padding-bottom:2rem;
          padding-top:.25rem;
        }
        ...
        @media(max-width:500px){
          .pricing-grid{ grid-template-columns:1fr; gap:.7rem; }
        }

        .plan-card {
          background:rgba(18,14,5,0.85);border:1px solid rgba(201,168,76,0.18);border-radius:1rem;
          padding:1.4rem 1.2rem;display:flex;flex-direction:column;gap:.7rem;position:relative;overflow:hidden;
        ...
        /* على الموبايل — الـ hot card تيجي أول */
        @media(max-width:500px){
        ...
        .plan-cta {
          margin-top:auto;width:100%;padding:.65rem;border-radius:.6rem;font-size:.8rem;font-weight:800;
          cursor:pointer;border:1.5px solid rgba(201,168,76,0.4);background:transparent;color:var(--gold-light);
          transition:all .2s;letter-spacing:.04em;display:flex;align-items:center;justify-content:center;gap:.45rem;
        ...
        .pricing-close-row {
          ...
          background:linear-gradient(to bottom,rgba(6,5,4,0.95) 80%,transparent);
        }
        ...
        /* تابلت */
        @media(max-width:900px){
          .pricing-ov{ padding:.8rem; }
          .pricing-title{ font-size:1.4rem; }
        }
        /* موبايل */
        @media(max-width:500px){
          .pricing-ov{ padding:.6rem; }
          .pricing-wrap{ padding-bottom:1.5rem; }
          .pricing-title{ font-size:1.25rem; }
          .pricing-sub{ font-size:.78rem; }
          .billing-toggle{ gap:.5rem; }
          .billing-label{ font-size:.78rem; }
          .plan-card{ padding:1.2rem 1rem; }
          .plan-amount{ font-size:1.6rem; }
          .contact-btn{ font-size:.76rem;padding:.5rem 1rem; }
          .pricing-note{ font-size:.7rem; }
        }
        /* موبايل صغير جداً */
        @media(max-width:360px){
          .pricing-ov{ padding:.4rem; }
          .plan-amount{ font-size:1.4rem; }
          .plan-feat{ font-size:.74rem; }
        }
      `}),e.jsx("div",{className:"lp",children:e.jsxs("div",{className:"hc",children:[e.jsxs("div",{className:"fu1 logo-wrap",children:[e.jsx("div",{className:"logo-ring",children:e.jsx("img",{src:"/logo.jpg",alt:"Caprina"})}),e.jsxs("div",{className:"logo-text-block",children:[e.jsx("span",{className:"logo-brand",children:"CAPRINA"}),e.jsx("span",{className:"logo-sub",children:"Operations System"})]})]}),e.jsx("div",{className:"fu2 gold-divider"}),e.jsx("div",{className:"fu2",children:e.jsxs("h1",{className:"h-title",children:["مرحباً بك في",e.jsx("br",{}),e.jsx("span",{className:"g",children:"مركز العمليات"})]})}),e.jsx("div",{className:"fu3",children:e.jsx("p",{className:"h-desc",children:"نظام متكامل لإدارة الطلبيات والعمليات وتنفيذها على نطاق واسع"})}),e.jsx("div",{className:"fu3",children:e.jsx("span",{className:"tagline",children:"WIN OR DIE"})}),e.jsxs("div",{className:"fu4 btn-row",children:[e.jsxs("button",{className:"btn-primary",onClick:()=>l(!0),children:[e.jsx(h,{size:18})," تسجيل الدخول"]}),e.jsxs("button",{className:"btn-ghost",onClick:()=>d(!0),children:[e.jsx(w,{size:18})," الباقات والأسعار"]}),e.jsxs("a",{href:"https://caprinaeg.com",target:"_blank",rel:"noopener noreferrer",className:"btn-ghost",children:[e.jsx($,{size:18})," الموقع الرئيسي"]})]}),e.jsxs("div",{className:"fu5 copy-bar",children:[e.jsx("div",{className:"copy-line"}),e.jsx("span",{className:"copy-text",children:"جميع الحقوق محفوظة © CAPRINA 2026"}),e.jsx("div",{className:"copy-line r"})]})]})}),P&&e.jsx("div",{className:"ov",onClick:()=>l(!1),children:e.jsxs("div",{className:"card",onClick:r=>r.stopPropagation(),children:[e.jsx("div",{className:"card-top-line"}),e.jsxs("div",{className:"card-head",children:[e.jsxs("div",{className:"card-head-left",children:[e.jsx("div",{className:"card-icon",children:e.jsx(x,{size:19})}),e.jsxs("div",{children:[e.jsx("div",{className:"card-title",children:"تسجيل الدخول"}),e.jsx("div",{className:"card-sub",children:"أدخل بياناتك للمتابعة إلى لوحة التحكم"})]})]}),e.jsx("button",{className:"btn-x",onClick:()=>l(!1),children:e.jsx(f,{size:13})})]}),e.jsxs("form",{onSubmit:Y,children:[e.jsxs("label",{className:"f-label",children:[e.jsx(u,{size:12})," اسم المستخدم"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(u,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",value:o,onChange:r=>N(r.target.value),placeholder:"أدخل اسم المستخدم",autoComplete:"username",autoFocus:!0})]}),e.jsxs("label",{className:"f-label",children:[e.jsx(x,{size:12})," كلمة المرور"]}),e.jsxs("div",{className:"f-wrap",children:[e.jsx(D,{className:"f-ico-r",size:15}),e.jsx("input",{className:"f-input",type:c?"text":"password",value:s,onChange:r=>z(r.target.value),placeholder:"••••••••",autoComplete:"current-password",style:{paddingLeft:"2.6rem"}}),e.jsx("button",{type:"button",className:"f-ico-l",onClick:()=>C(r=>!r),children:c?e.jsx(R,{size:14}):e.jsx(G,{size:14})})]}),e.jsx("button",{type:"submit",className:"btn-sub",disabled:g||!o.trim()||!s,children:g?e.jsx(e.Fragment,{children:"جاري التحقق..."}):e.jsxs(e.Fragment,{children:[e.jsx(h,{size:17})," دخول آمن"]})})]})]})}),S&&e.jsx("div",{className:"pricing-ov",onClick:()=>d(!1),children:e.jsxs("div",{className:"pricing-wrap",onClick:r=>r.stopPropagation(),children:[e.jsx("div",{className:"pricing-close-row",children:e.jsx("button",{className:"btn-x",onClick:()=>d(!1),style:{width:36,height:36,flexShrink:0},children:e.jsx(f,{size:15})})}),e.jsxs("div",{className:"pricing-head",children:[e.jsxs("h2",{className:"pricing-title",children:["اختر ",e.jsx("span",{className:"g",children:"الباقة المناسبة"})]}),e.jsx("p",{className:"pricing-sub",children:"جميع الباقات تشمل وصولاً كاملاً للنظام — فقط الحدود تختلف"})]}),e.jsxs("div",{className:"billing-toggle",children:[e.jsx("span",{className:`billing-label${t?"":" active"}`,children:"شهري"}),e.jsx("div",{className:`toggle-track${t?" on":""}`,onClick:()=>X(r=>!r),children:e.jsx("div",{className:"toggle-thumb"})}),e.jsx("span",{className:`billing-label${t?" active":""}`,children:"سنوي"}),t&&e.jsx("span",{className:"saving-badge",children:"🎁 شهرين مجاناً"})]}),e.jsx("div",{className:"pricing-grid",children:W.map(r=>{const n=r.icon,a=t&&r.yearlyPrice,F=a?r.yearlyPrice.toLocaleString("ar-EG"):r.priceDisplay,m=a?"سنوياً":r.period,E=encodeURIComponent(`مرحباً، أريد الاشتراك في باقة ${r.label} ${a?"السنوية":"الشهرية"} من نظام Caprina`);return e.jsxs("div",{className:`plan-card${r.highlight?" hot":""}`,children:[r.highlight&&e.jsxs("div",{className:"plan-badge",children:["★ ",r.badge]}),e.jsx("div",{className:"plan-icon",children:e.jsx(n,{size:18})}),e.jsx("div",{className:"plan-name",children:r.label}),e.jsxs("div",{className:"plan-price",children:[e.jsx("span",{className:"plan-amount",children:F}),m&&e.jsxs("span",{className:"plan-period",children:["ج.م / ",m]})]}),a&&r.yearlySaving&&e.jsxs("div",{children:[e.jsxs("div",{className:"plan-yearly-info",children:["بدلاً من ",(r.monthlyPrice*12).toLocaleString("ar-EG")," ج.م"]}),e.jsxs("span",{className:"plan-saving",children:["وفّر ",r.yearlySaving.toLocaleString("ar-EG")," ج.م"]})]}),!a&&r.yearlyPrice&&e.jsxs("div",{className:"plan-yearly-info",children:["السنوي: ",r.yearlyPrice.toLocaleString("ar-EG")," ج.م — وفّر ",r.yearlySaving," ج.م"]}),e.jsx("div",{className:"plan-divider"}),e.jsx("div",{className:"plan-features",children:r.features.map(b=>e.jsxs("div",{className:"plan-feat",children:[e.jsx(O,{size:12})," ",b]},b))}),e.jsxs("a",{href:`https://wa.me/201XXXXXXXXX?text=${E}`,target:"_blank",rel:"noopener noreferrer",className:`plan-cta${r.highlight?" hot":""}`,children:[e.jsx(v,{size:14}),r.key==="enterprise"?"تواصل معنا":"ابدأ الآن"]})]},r.key)})}),e.jsxs("div",{className:"pricing-contact",children:[e.jsxs("a",{href:"https://wa.me/201XXXXXXXXX",target:"_blank",rel:"noopener noreferrer",className:"contact-btn contact-wa",children:[e.jsx(v,{size:15})," واتساب"]}),e.jsxs("a",{href:"mailto:info@caprinaeg.com",className:"contact-btn contact-mail",children:[e.jsx(Z,{size:15})," info@caprinaeg.com"]})]}),e.jsxs("p",{className:"pricing-note",children:["الأسعار بالجنيه المصري · التفعيل خلال 24 ساعة · لا توجد رسوم خفية",e.jsx("br",{}),"البيانات محفوظة حتى بعد انتهاء الاشتراك"]})]})})]})}export{Q as default};
