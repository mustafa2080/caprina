import{j as e}from"./vendor-query-Bj6efJQO.js";import{u as j,r}from"./vendor-router-D4U-j562.js";import{i as v,u as w,d as N,E as S,L as m,I as c,B as k,F as L}from"./index-BAubA54f.js";import{al as B,L as C,am as E,af as z}from"./vendor-icons-CMIab_CS.js";import"./vendor-ui-0K0Ol4RT.js";import"./vendor-charts-BJCyhj9w.js";function I(){const{brand:o}=v(),{login:g}=w(),[,x]=j(),{toast:p}=N(),[s,u]=r.useState(""),[a,b]=r.useState(""),[i,h]=r.useState(!1),[n,d]=r.useState(!1),f=async t=>{if(t.preventDefault(),!(!s.trim()||!a)){d(!0);try{const{token:l,user:y}=await L.login(s.trim(),a);g(l,y),x("/")}catch(l){p({title:"خطأ في تسجيل الدخول",description:l.message,variant:"destructive"})}finally{d(!1)}}};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .login-outer {
          position: fixed;
          inset: 0;
          display: flex;
